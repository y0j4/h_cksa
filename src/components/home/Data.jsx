...
const Data = () => {
  return (
    <div className="home__data">
        ...
        <h3 className="home__subtitle">Creative Solutions</h3>
        <p className="home__description">Agencia de diseño gráfico con sede en Alicante que convierte tus ideas en una realidad.</p>
